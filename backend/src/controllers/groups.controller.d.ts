...
export declare const getGroups: (request: FastifyRequest, reply: FastifyReply) => Promise<never>;
export declare const createGroup: (request: FastifyRequest, reply: FastifyReply) => Promise<never>;
export declare const updateGroup: (request: FastifyRequest, reply: FastifyReply) => Promise<never>;
