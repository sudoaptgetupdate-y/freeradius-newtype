...
export class MikrotikService {
     ...
     */
    static getClient({ ip, username, password }) {
     ...
     */
    static async getSystemResource(credentials) {
        try {
     ...
     * Fetches DHCP Leases
     */
    static async getDhcpLeases(credentials) {
        try {
            const client = this.getClient(credentials);
     ...
     */
    static async kickHotspotUser(credentials, username) {
        try {
            const client = this.getClient(credentials);
